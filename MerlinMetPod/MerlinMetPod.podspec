...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Camila Gaitán Mosquera"
  # s.authors            = { "Camila Gaitán Mosquera" => "camila@merlinjobs.com" }
  # s.social_media_url   = "http://twitter.com/Camila Gaitán Mosquera"
  ...
  s.source       = { :git => "http://EXAMPLE/MerlinMetPod.git", :tag => "#{s.version}" }
